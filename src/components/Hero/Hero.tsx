    ...
    <section className={styles.hero}>
      <div className={styles.content}>
        ...
        <p className={styles.tagline}>
          A multi-agent AI workflow where specialized personas take a feature from brief to shipped code. Product, design, engineering, and security agents collaborate end-to-end so you don&apos;t have to babysit every handoff.
        </p>
